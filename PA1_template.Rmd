...
The mean day has **`r daymean`** steps.
The median day has **`r daymedian`** steps.
...
The most active five minute interval of activity in military time is **`r topinterval`**. 
...
The mean of the new data is **`r nonamean`** and the median of the new data is **`r nonamedian`**. 
